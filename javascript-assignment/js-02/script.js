...
var StudentName = "JHON DOE" , age = 15 , course = " Certified Mobile Application Development";
alert(StudentName);
alert(age + " years old");
alert(course);
...
document.write("Yah ! I can write HTML content using JavaScript.")
